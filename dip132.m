...
function status = dip132(Mu,coord,Rmax,filename,Rz,N,gpu,log)
pathname = pwd;
...
[~,Sx,Sy,Sz,geo] = chgcar([filename '/CHGCAR']);
...
fid = fopen([filename '/LOCPOT']); geo1 = poscar(fid); fgetl(fid);
...
if log == 1
    ...
    fprintf(fid,'   ============================================ \n');
    fprintf(fid,'          Spin Density + ZPE Calculation \n');
    fprintf(fid,'   ============================================ \n');
